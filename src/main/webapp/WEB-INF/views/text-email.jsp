		...
		<div class="container">
			<div class="signup-content">
				<div class="signup-form">
					...
					<form:form modelAttribute="textEmail" method="POST"
						action="/email-app/sendTextEmail" cssClass="register-form"
						id="register-form">
						...
						<div class="form-group">
							...
							<form:input type="email" path="email" name="email" id="email"
								placeholder="Email (Mail will be sent to this ID)"
								required="required" />
						...
						<div class="form-group form-button">
							<input type="submit" name="signup" id="signup"
								class="form-submit" value="Send Email" />
						</div>
					</form:form>
				</div>
				<div class="signup-image">
					...
					<div style="display: flex; justify-content: space-between;">
						<a
							...
							class="signup-image-link">Send Email With Attachment</a> <a
							href="${pageContext.request.contextPath}/email-app/home"
